...
import { randNth, arrayOfSize, isNumber, wordWrap, errorMessage } from "./helpers";
...
export default class LoremIpsum {
  ...
  //     }
  //
  //     const setIntProp = prop => isNumber(optionInt) ? optionInt : prop;
  //
  //     switch (optionString) {
  //       case "p":
  //         conf.unitType = "paragraph";
  //         // conf.unitCount = isNumber(optionInt) ? optionInt : w.DEFAULT_UNIT_COUNT;
  ...
  //       case "wrap":
  //         conf.isWrapped = true;
  //         // conf.wrapWidth = isNumber(optionInt) ? optionInt : w.DEFAULT_WRAP_WIDTH
